...
export default function GlobalAIModal() {
  const { isOpen, modalData, closeModal } = useAIModal();
        ...
        <div className="h-full flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col items-center justify-center">
            <div className="relative w-96 h-96 mb-6">
              <Image
                src={modalData.url_cover_album_big}
                alt={`${modalData.name_artist} - ${modalData.name_song}`}
                fill
                className="object-cover rounded-xl shadow-lg"
              />
            </div>
            <h3 className="text-3xl font-bold text-center mb-3">{modalData.name_song}</h3>
            <p className="text-2xl text-gray-600 text-center">{modalData.name_artist}</p>
          </div>
          ...
          <div className="lg:w-1/2 flex flex-col justify-center space-y-8">
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">{modalData.theme}</p>
            </div>
